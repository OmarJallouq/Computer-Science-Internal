...
public class DeleteEmployee extends javax.swing.JFrame {
    ...
    private void initComponents(){
        ...
        TitleLabel.setText("Delete Existing Employees");
    ...
    private void DeleteItemActionPerformed(ActionEvent evt) {
        ...
        int confirmation = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete the selected employee?");
        
        if(confirmation == 0){
            int n = DBMethods.deleteEmployeeRecord(id);
