...
public class ModifyRentals extends javax.swing.JFrame {
    public ModifyRentals(){
        initComponents();
        jScrollPane.setVisible(true);
        try{
            ResultSet rs = DBMethods.getAllCurrentRental();
            ItemList.removeAll();
            DefaultListModel<String> model = new DefaultListModel<>();
            ItemList.setModel(model);

            while(rs.next()){
                model.addElement(rs.getInt(1) + " " + rs.getString(2) + " " + rs.getString(3) + " " + rs.getString(4));
            }
        }
    ...
    private void initComponents(){
        ...
        TitleLabel.setText("View/Modify Existing Rentals");
    ...
    private void EditItemActionPerformed(ActionEvent evt) {
        ...
        EditSpecificRental E = new EditSpecificRental(id);
        E.setVisible(true);
    }
